/*
9 - Faça um algoritmo que calcule a média ponderada das notas de 3 provas. A primeira e a segunda prova têm peso 1 e a
terceira tem peso 2. Ao final, mostrar a média do aluno e indicar se o aluno foi aprovado ou reprovado. A nota para aprovação
deve ser igual ou superior a 60 pontos. Este programa deverá ser executado quando o usuário apertar 8 no menu da primeira atividade.
*/
#include <stdio.h>
#include <math.h>
